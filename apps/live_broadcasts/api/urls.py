...
from .views import (
    ...
    AdminLiveMinutePricingListView,
    AdminLiveStreamingCostSummaryView,
    AdminLiveStreamingPolicyView,
    AdminSetLiveMinutePriceView,
...
urlpatterns = [
    ...
    path("admin/policy/", AdminLiveStreamingPolicyView.as_view(), name="admin-live-streaming-policy"),
    path("admin/pricing/", AdminLiveMinutePricingListView.as_view(), name="admin-live-minute-pricing-list"),
    path("admin/pricing/set/", AdminSetLiveMinutePriceView.as_view(), name="admin-live-minute-pricing-set"),
    path("admin/cost-summary/", AdminLiveStreamingCostSummaryView.as_view(), name="admin-live-streaming-cost-summary"),
]
