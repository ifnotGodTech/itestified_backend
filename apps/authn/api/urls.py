...
urlpatterns = [
    ...
    path("mobile/change-password/", MobileChangePasswordView.as_view(), name="auth-mobile-change-password"),
    path("mobile/delete-account/", MobileDeleteAccountView.as_view(), name="auth-mobile-delete-account"),
